...
- `default_bmc_password` (String) Password for accessing the Expected Machine's BMC
- `default_bmc_username` (String) Username for accessing the Expected Machine's BMC
