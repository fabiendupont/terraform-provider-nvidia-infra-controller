...
page_title: "nico_ssh_key_group Data Source - nico"
subcategory: ""
description: |-
...
# nico_ssh_key_group (Data Source)
...
- `instance_id` (String) Filter SSH Key Groups by Instance ID
- `query` (String) Search for matches across all SSH Key Groups. Input will be matched against the name field
- `site_id` (String) Filter SSH Key Groups by Site ID
