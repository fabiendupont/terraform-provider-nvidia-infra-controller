...
- `power_resource_group` (String) External power provisioning resource group associated with the VPC.
...
- `routing_profile_overrides` (String) Routing-profile properties set directly on the VPC. Unset properties inherit from the named routing profile.
